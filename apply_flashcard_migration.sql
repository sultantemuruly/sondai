-- Flashcard Migration
-- Run this SQL file against your database to create the flashcard tables
...
ALTER TABLE "flashcard_groups" ADD CONSTRAINT "flashcard_groups_folder_id_folders_id_fk" FOREIGN KEY ("folder_id") REFERENCES "public"."folders"("id") ON DELETE no action ON UPDATE no action;
ALTER TABLE "flashcard_groups" ADD CONSTRAINT "flashcard_groups_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
